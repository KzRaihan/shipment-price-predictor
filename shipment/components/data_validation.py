...
class DataValidation:
    ...
    # Check the Numerical columns are exists or not
    ...
    # Check the Categorical columns are exists or not
    ...
    # Check the validation of Schema (all columns) on train and test 
    ...
    # Check the Numerical columns validation  on train and test 
    ...
    # Check the categorical columns validation  on train and test 
    ...
    # Detects whether data drift is present or not.
